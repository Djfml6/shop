...
class StoreController extends Controller
{
    ...
    public function show(StoreService $store_service, GoodsService $goods_service, $id){
        $info = $store_service->getStoreInfoAndRate($id,'id,store_name,store_company_name,area_info,store_address,store_slide');
        $info['sale_list'] = $goods_service->getStoreSaleGoods(['store_id' => $id]);
        return $this->success($info);
